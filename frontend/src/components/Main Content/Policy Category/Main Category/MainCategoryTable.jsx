    ...
    try {
      ...
      if (response.ok) {
        ...
        if (isEditMode) {
          ...
          showSuccessToast("Main Category Updated successfully!");
        } else {
          setMainCategory((prevMainCategory) => [
            ...prevMainCategory,
            newMainCategory,
          ]);
          showSuccessToast("Main Category Inserted Successfully!");
        }
        setIsEditMode(false);
    ...
    const confirmDeletion = async () => {
      try {
        ...
        if (response.ok) {
          ...
          modal.hide();
          showSuccessToast("Main Category deleted successfully!");
        } else {
        ...
        showSuccessToast("An error occurred while deleting the main category.");
      }
    };
